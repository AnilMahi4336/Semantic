...
def main(params):
    ...
    torch.load(args.checkpoint_path, map_location=lambda storage, loc: storage)
    print('Done!')
...
if __name__ == '__main__':
    params = [
              '--image',
              '--data', '/Users/anil/Desktop/Documents/BiSeNet-master/dataset/CamVid/train_labels/0001TP_006720_L.png',
              '--checkpoint_path', '/Users/anil/Desktop/Documents/BiSeNet-master/epoch_50.pth',
              '--cuda', '4',
              '--csv_path', '/Users/anil/Desktop/Documents/BiSeNet-master/dataset/CamVid/class_dict.csv',
              '--save_path', '/Users/anil/Desktop/Documents/BiSeNet-master/demo.png'
              ]
    main(params)
